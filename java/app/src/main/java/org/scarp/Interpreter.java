...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        if (stmt.initializer != null) {
            environment.define(stmt.name.lexeme, evaluate(stmt.initializer), stmt.isConst);
        } else {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.base != null) {
            ...
            environment.define("base", base, false);
        }
        ...
        for (Stmt.Function method : stmt.methods) {
            ScFunction function = new ScFunction(method, environment, stmt.name.lexeme.equals("init"),
                    method.modifiers);
        ...
        switch (expr.operator.type) {
            ...
            case PLUS:
                ...
                throw new RuntimeError(
                        expr.operator, "Operands must be two numbers or a string and any type.");
            case GREATER:
            case GREATER_EQUAL:
            case LESS:
            case LESS_EQUAL:
    ...
    public Object visitCallExpr(Expr.Call expr) {
        ...
        if (args.size() != function.arity()) {
            throw new RuntimeError(
                    expr.paren, "Expected " + function.arity() + " arguments but got " + args.size() + ".");
        }
